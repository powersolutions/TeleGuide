...
public class RecentAdapter extends BaseAdapter {
	...
	public RecentAdapter(Context context, ArrayList<String> todayValues, ArrayList<String> link) {
		this.context = context;
		this.todayValues = todayValues;
		this.link = link;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			gridview = inflater.inflate(R.layout.recentitem, null);

			// set value into text view
			TextView textview = (TextView) gridview
					.findViewById(R.id.grid_item_label_recent);

			textview.setText(todayValues.get(position));

			// set image
			ImageView image = (ImageView) gridview
					.findViewById(R.id.grid_item_image_recent);
