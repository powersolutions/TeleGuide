...
public class MyShowAdapter extends BaseAdapter {
	...
	public MyShowAdapter(Context context, ArrayList<String> todayValues, ArrayList<String> link) {
		this.context = context;
		this.todayValues = todayValues;
		this.link = link;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			gridview = inflater.inflate(R.layout.myshowsitem, null);

			// set value into text view
			TextView textview = (TextView) gridview
					.findViewById(R.id.myshow_item_label);

			textview.setText(todayValues.get(position));

			// set image
			ImageView image = (ImageView) gridview
					.findViewById(R.id.myshow_item_image);
